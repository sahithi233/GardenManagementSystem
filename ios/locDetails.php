...
$selectedLocation = isset($_GET['location']) ? mysqli_real_escape_string($conn, $_GET['location']) : '';
...
if (!empty($results)) {
    ...
    $response["message"] = "No supervisors available";
    $response["data"] = array(); // Empty array for data
}
